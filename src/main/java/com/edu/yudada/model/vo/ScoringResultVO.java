...
public class ScoringResultVO implements Serializable {
    ...
    public static ScoringResult voToObj(ScoringResultVO scoringResultVO) {
        ...
        scoringResult.setResultProp(JSONUtil.toJsonStr(scoringResultVO.getResultProp()));// 将java对象转换成对应的json字符串
    ...
    public static ScoringResultVO objToVo(ScoringResult scoringResult) {
        ...
        scoringResultVO.setResultProp(JSONUtil.toList(scoringResult.getResultProp(), String.class)); //将json字符串转换成对应的java对象
